...
interface TimerModalProps {
  isOpen: boolean;
  onClose: () => void;
  timer?: Timer; // Optional prop to distinguish between Add and Edit
}
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <button
              type="submit"
              className="px-4 py-2 text-sm font-medium text-white rounded-md transition-colors bg-blue-700 hover:bg-blue-600"
